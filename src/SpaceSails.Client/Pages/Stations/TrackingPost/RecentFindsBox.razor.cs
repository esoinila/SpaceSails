...
// RecentFindsBox — the code-behind for RecentFindsBox.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of RecentFindsBox.razor, character for character, in the
...
public partial class RecentFindsBox
{
    ...
    [Parameter] public IReadOnlyList<Discovery> _recentFinds { get; set; } = [];
    [Parameter] public Func<DiscoveryKind, string> FindIcon { get; set; } = default!;
}
