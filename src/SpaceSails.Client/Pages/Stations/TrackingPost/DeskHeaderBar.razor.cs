...
// DeskHeaderBar — the code-behind for DeskHeaderBar.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of DeskHeaderBar.razor, character for character, in the
...
public partial class DeskHeaderBar
{
    // #251 item 1 · Every [Parameter] below is a member of TrackingPost under the member's own name.
