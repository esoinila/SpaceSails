...
// LedgerTable — the code-behind for LedgerTable.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of LedgerTable.razor, character for character, in the
...
public partial class LedgerTable
{
    ...
    /// <summary>the desk's `HashSet&lt;string&gt; _aware` — the SAME set, not a copy.</summary>
