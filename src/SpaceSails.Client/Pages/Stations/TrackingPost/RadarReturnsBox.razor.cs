...
// RadarReturnsBox — the code-behind for RadarReturnsBox.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of RadarReturnsBox.razor, character for character, in the
...
public partial class RadarReturnsBox
{
