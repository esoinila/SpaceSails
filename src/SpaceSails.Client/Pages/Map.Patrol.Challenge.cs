...
// Subject: part of Map.Patrol (#870 split; the header note lives in Map.Patrol.cs) — #833's approach — the hail a notice buys, the walk across the floor, and walking away from it — then the challenge itself and #836's wallet: what goes into his hand, what he reads, and what the captain's own book remembers about it.
