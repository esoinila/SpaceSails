...
// Subject: part of the patrol (#870 lane 6′c; the header note lives in Map.Patrol.cs) — where the site's own pass comes from, #835's earned run and the hand on your arm, the kick-out back to the sky and the plate over the shed — and the figures the captain may actually see. Plus the two errands that are not about a person at all: #602's keypad calling its own security, and #618's gun going off within earshot — one walk to a place, two things that start it.
