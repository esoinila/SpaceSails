...
// Subject: part of Map.Patrol (#870 split; the header note lives in Map.Patrol.cs) — where the site's own pass comes from, #835's earned run and the hand on your arm, the kick-out back to the sky and the plate over the shed — and the figures the captain may actually see.
