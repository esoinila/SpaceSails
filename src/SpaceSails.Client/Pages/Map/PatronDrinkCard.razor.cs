...
// PatronDrinkCard — the code-behind for PatronDrinkCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of PatronDrinkCard.razor, character for character, in the
...
public partial class PatronDrinkCard
{
    ...
    [Parameter] public string patron { get; set; } = default!;
    [Parameter] public Core.Interior.Barkeep patronKeep { get; set; } = default!;
