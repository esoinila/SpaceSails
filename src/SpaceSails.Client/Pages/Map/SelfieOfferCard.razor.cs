...
// SelfieOfferCard — the code-behind for SelfieOfferCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of SelfieOfferCard.razor, character for character, in the
...
public partial class SelfieOfferCard
{
    ...
    [Parameter] public EventCallback AcceptSelfieOffer { get; set; }
    [Parameter] public EventCallback DeclineSelfieOffer { get; set; }
    [Parameter] public Func<Action, Task> Dismiss { get; set; } = default!;
    [Parameter] public SelfieOffer selfieOffer { get; set; } = default!;
