...
// ShipEpitaphCard — the code-behind for ShipEpitaphCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of ShipEpitaphCard.razor, character for character, in the
...
public partial class ShipEpitaphCard
{
    ...
    [Parameter] public ShipEpitaph castaway { get; set; } = default!;
