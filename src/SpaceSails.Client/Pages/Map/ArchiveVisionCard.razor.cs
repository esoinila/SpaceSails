...
// ArchiveVisionCard — the code-behind for ArchiveVisionCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of ArchiveVisionCard.razor, character for character, in the
...
public partial class ArchiveVisionCard
{
    ...
    [Parameter] public ArchiveCard vision { get; set; } = default!;
