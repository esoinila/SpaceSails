...
// NavHelpCard — the code-behind for NavHelpCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of NavHelpCard.razor, character for character, in the
...
public partial class NavHelpCard
{
