...
// PendingOfferCard — the code-behind for PendingOfferCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of PendingOfferCard.razor, character for character, in the
...
public partial class PendingOfferCard
{
