...
// WreckOutcomeCard — the code-behind for WreckOutcomeCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of WreckOutcomeCard.razor, character for character, in the
...
public partial class WreckOutcomeCard
{
    ...
    [Parameter] public Derelict.SalvageOutcome salvageOutcome { get; set; } = default!;
