...
// RepCard — the code-behind for RepCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of RepCard.razor, character for character, in the
