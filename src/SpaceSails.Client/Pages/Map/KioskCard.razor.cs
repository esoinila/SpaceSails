...
// KioskCard — the code-behind for KioskCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of KioskCard.razor, character for character, in the
...
public partial class KioskCard
{
    ...
    [Parameter] public KioskBuy buy { get; set; } = default!;
