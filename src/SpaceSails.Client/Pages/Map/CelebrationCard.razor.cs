...
// CelebrationCard — the code-behind for CelebrationCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of CelebrationCard.razor, character for character, in the
...
public partial class CelebrationCard
{
    ...
    [Parameter] public EventCallback DismissCelebration { get; set; }
