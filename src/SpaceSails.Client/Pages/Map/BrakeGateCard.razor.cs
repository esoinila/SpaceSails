...
// BrakeGateCard — the code-behind for BrakeGateCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of BrakeGateCard.razor, character for character, in the
...
public partial class BrakeGateCard
{
    ...
    [Parameter] public EventCallback DeclineArrivalBrake { get; set; }
    [Parameter] public Func<Action, Task> Dismiss { get; set; } = default!;
    [Parameter] public EventCallback FireArrivalBrake { get; set; }
