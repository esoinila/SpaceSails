...
// RescueOfferCard — the code-behind for RescueOfferCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of RescueOfferCard.razor, character for character, in the
...
public partial class RescueOfferCard
{
