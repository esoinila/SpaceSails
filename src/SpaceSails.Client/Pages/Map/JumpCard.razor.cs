...
// JumpCard — the code-behind for JumpCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of JumpCard.razor, character for character, in the
