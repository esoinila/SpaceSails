...
// DeckBannerStrip — the code-behind for DeckBannerStrip.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of DeckBannerStrip.razor, character for character, in the
...
public partial class DeckBannerStrip
{
