...
// DoorBoardPanel — the code-behind for DoorBoardPanel.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of DoorBoardPanel.razor, character for character, in the
...
public partial class DoorBoardPanel
{
