...
// StoryCard — the code-behind for StoryCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of StoryCard.razor, character for character, in the
...
public partial class StoryCard
{
    ...
    [Parameter] public (StoryBeats.Beat Beat, string? Subject, string? Outcome) told { get; set; } = default!;
