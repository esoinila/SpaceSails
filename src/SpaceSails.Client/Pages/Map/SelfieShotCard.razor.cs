...
// SelfieShotCard — the code-behind for SelfieShotCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of SelfieShotCard.razor, character for character, in the
...
public partial class SelfieShotCard
{
    ...
    [Parameter] public EventCallback CloseSelfieShot { get; set; }
    [Parameter] public Func<Action, Task> Dismiss { get; set; } = default!;
    [Parameter] public CapturedSelfie shot { get; set; } = default!;
