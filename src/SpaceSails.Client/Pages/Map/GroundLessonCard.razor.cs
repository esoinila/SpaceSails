...
// GroundLessonCard — the code-behind for GroundLessonCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of GroundLessonCard.razor, character for character, in the
...
public partial class GroundLessonCard
{
