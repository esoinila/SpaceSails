...
// ExpeditionRevealPanel — the code-behind for ExpeditionRevealPanel.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of ExpeditionRevealPanel.razor, character for character, in the
...
public partial class ExpeditionRevealPanel
{
    ...
    [Parameter] public EventCallback DismissExpeditionReveal { get; set; }
    [Parameter] public Func<ExpeditionSiteKind, string> ExpeditionBriefArtCss { get; set; } = default!;
    [Parameter] public ExpeditionRevealCard reveal { get; set; } = default!;
