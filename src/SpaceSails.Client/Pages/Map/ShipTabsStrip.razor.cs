...
// ShipTabsStrip — the code-behind for ShipTabsStrip.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of ShipTabsStrip.razor, character for character, in the
...
public partial class ShipTabsStrip
{
