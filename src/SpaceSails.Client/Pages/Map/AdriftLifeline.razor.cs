...
// AdriftLifeline — the code-behind for AdriftLifeline.razor.
//
...
public partial class AdriftLifeline
{
    ...
    /// receiver of the press (#1135 clause 2). The press sets `_showRescueOffer`, which is what the `@if`
    /// above this surface reads — a press the page never heard would be a button doing nothing.</summary>
