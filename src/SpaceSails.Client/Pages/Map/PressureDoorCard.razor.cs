...
// PressureDoorCard — the code-behind for PressureDoorCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of PressureDoorCard.razor, character for character, in the
...
public partial class PressureDoorCard
{
