...
// WreckLookCard — the code-behind for WreckLookCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of WreckLookCard.razor, character for character, in the
...
public partial class WreckLookCard
{
    ...
    [Parameter] public WreckLook look { get; set; } = default!;
