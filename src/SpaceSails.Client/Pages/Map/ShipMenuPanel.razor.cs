...
// ShipMenuPanel — the code-behind for ShipMenuPanel.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of ShipMenuPanel.razor, character for character, in the
...
public partial class ShipMenuPanel
{
