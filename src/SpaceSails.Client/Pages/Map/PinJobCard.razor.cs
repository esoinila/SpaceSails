...
// PinJobCard — the code-behind for PinJobCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of PinJobCard.razor, character for character, in the
...
public partial class PinJobCard
{
    ...
    [Parameter] public EventCallback CancelPin { get; set; }
    [Parameter] public Func<Action, Task> Dismiss { get; set; } = default!;
    [Parameter] public EventCallback PinClear { get; set; }
    [Parameter] public string PinDisplay { get; set; } = default!;
    [Parameter] public Action<string> PinPush { get; set; } = default!;
    [Parameter] public EventCallback SubmitPin { get; set; }
