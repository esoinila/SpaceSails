...
// WreckChoiceCard — the code-behind for WreckChoiceCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of WreckChoiceCard.razor, character for character, in the
...
public partial class WreckChoiceCard
{
