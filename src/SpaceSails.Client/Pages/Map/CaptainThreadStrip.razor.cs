...
// CaptainThreadStrip — the code-behind for CaptainThreadStrip.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of CaptainThreadStrip.razor, character for character, in the
...
public partial class CaptainThreadStrip
{
    ...
    [Parameter] public GameThreadInfo capThread { get; set; } = default!;
