...
// ImportConfirmCard — the code-behind for ImportConfirmCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of ImportConfirmCard.razor, character for character, in the
...
public partial class ImportConfirmCard
{
