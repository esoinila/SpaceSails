...
// LockedDoorCard — the code-behind for LockedDoorCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of LockedDoorCard.razor, character for character, in the
...
public partial class LockedDoorCard
{
    ...
    [Parameter] public EventCallback OpenSatchelAtTheDoor { get; set; }
    [Parameter] public LockedDoorLook door { get; set; } = default!;
