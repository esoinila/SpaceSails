...
// TutorialCard — the code-behind for TutorialCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of TutorialCard.razor, character for character, in the
...
public partial class TutorialCard
{
