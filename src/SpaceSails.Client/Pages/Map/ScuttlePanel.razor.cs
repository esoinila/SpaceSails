...
// ScuttlePanel — the code-behind for ScuttlePanel.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of ScuttlePanel.razor, character for character, in the
...
public partial class ScuttlePanel
{
    ...
    [Parameter] public EventCallback AbortTheOverload { get; set; }
    [Parameter] public EventCallback ArmTheOverload { get; set; }
    ...
    [Parameter] public Derelict.Wreck scWreck { get; set; } = default!;
