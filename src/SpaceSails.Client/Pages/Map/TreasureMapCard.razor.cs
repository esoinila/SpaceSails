...
// TreasureMapCard — the code-behind for TreasureMapCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of TreasureMapCard.razor, character for character, in the
...
public partial class TreasureMapCard
{
    ...
    [Parameter] public EventCallback DismissMapCard { get; set; }
