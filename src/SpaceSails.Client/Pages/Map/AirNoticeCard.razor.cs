...
// AirNoticeCard — the code-behind for AirNoticeCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of AirNoticeCard.razor, character for character, in the
...
public partial class AirNoticeCard
{
