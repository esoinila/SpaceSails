...
// VentReadCard — the code-behind for VentReadCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of VentReadCard.razor, character for character, in the
...
public partial class VentReadCard
{
    ...
    [Parameter] public string readRoom { get; set; } = default!;
    [Parameter] public (DiceRoll Roll, HullVenting.LifeSign Sign) readShown { get; set; } = default!;
