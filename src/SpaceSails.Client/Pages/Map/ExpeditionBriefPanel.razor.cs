...
// ExpeditionBriefPanel — the code-behind for ExpeditionBriefPanel.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of ExpeditionBriefPanel.razor, character for character, in the
...
public partial class ExpeditionBriefPanel
{
    ...
    [Parameter] public EventCallback DismissExpeditionBrief { get; set; }
    [Parameter] public Func<ExpeditionSiteKind, string> ExpeditionBriefArtCss { get; set; } = default!;
    [Parameter] public ExpeditionBriefCard brief { get; set; } = default!;
