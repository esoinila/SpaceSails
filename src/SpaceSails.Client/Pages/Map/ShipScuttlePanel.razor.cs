...
// ShipScuttlePanel — the code-behind for ShipScuttlePanel.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of ShipScuttlePanel.razor, character for character, in the
...
public partial class ShipScuttlePanel
{
    ...
    [Parameter] public EventCallback AskTheCrewForTheSecondKey { get; set; }
    [Parameter] public EventCallback BackTheKeysOut { get; set; }
    [Parameter] public Action CloseShipScuttlePanel { get; set; } = default!;
    [Parameter] public Func<Action, Task> Dismiss { get; set; } = default!;
    [Parameter] public EventCallback GiveTheWordAgainstHer { get; set; }
    [Parameter] public EventCallback TurnBothKeys { get; set; }
