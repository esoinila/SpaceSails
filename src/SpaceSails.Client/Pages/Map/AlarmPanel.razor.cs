...
// AlarmPanel — the code-behind for AlarmPanel.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of AlarmPanel.razor, character for character, in the
...
public partial class AlarmPanel
{
    ...
    [Parameter] public EventCallback HackTheAlarm { get; set; }
