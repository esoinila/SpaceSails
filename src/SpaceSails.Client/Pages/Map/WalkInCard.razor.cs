...
// WalkInCard — the code-behind for WalkInCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of WalkInCard.razor, character for character, in the
...
public partial class WalkInCard
{
    ...
    [Parameter] public WalkIn.Who sheAsks { get; set; } = default!;
