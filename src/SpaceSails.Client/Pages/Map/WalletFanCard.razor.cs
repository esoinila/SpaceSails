...
// WalletFanCard — the code-behind for WalletFanCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of WalletFanCard.razor, character for character, in the
...
public partial class WalletFanCard
{
