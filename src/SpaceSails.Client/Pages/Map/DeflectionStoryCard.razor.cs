...
// DeflectionStoryCard — the code-behind for DeflectionStoryCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of DeflectionStoryCard.razor, character for character, in the
...
public partial class DeflectionStoryCard
{
    ...
    [Parameter] public EventCallback AdvanceDeflectionStory { get; set; }
    [Parameter] public Func<DeflectionStoryPanel, string> DeflectionPanelArtCss { get; set; } = default!;
    [Parameter] public Func<Action, Task> Dismiss { get; set; } = default!;
    [Parameter] public List<DeflectionStoryPanel> story { get; set; } = default!;
