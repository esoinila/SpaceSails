...
// TopBannerStack — the code-behind for TopBannerStack.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of TopBannerStack.razor, character for character, in the
...
public partial class TopBannerStack
{
