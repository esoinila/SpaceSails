...
// StandUpConfirmCard — the code-behind for StandUpConfirmCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of StandUpConfirmCard.razor, character for character, in the
...
public partial class StandUpConfirmCard
{
