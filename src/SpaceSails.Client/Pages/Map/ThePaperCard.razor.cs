...
// ThePaperCard — the code-behind for ThePaperCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of ThePaperCard.razor, character for character, in the
...
public partial class ThePaperCard
{
