...
// TubeRearmCard — the code-behind for TubeRearmCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of TubeRearmCard.razor, character for character, in the
...
public partial class TubeRearmCard
{
