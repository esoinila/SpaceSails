...
// BankSessionCard — the code-behind for BankSessionCard.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of BankSessionCard.razor, character for character, in the
...
public partial class BankSessionCard
{
