...
namespace SpaceSails.Client.Layout;

// NavMenu — the code-behind for NavMenu.razor.
//
...
//
// Nothing below was rewritten: it is the `@code` block of NavMenu.razor, character for character, in the
