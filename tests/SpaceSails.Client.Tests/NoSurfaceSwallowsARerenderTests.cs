...
/// the rAF-driven 200 ms throttle in <c>OnTick</c> and not to every mouse press. All 78 surfaces under
/// <c>Pages/Map/</c> repeat that override, which is what makes their crossings inert: with the suppression on
