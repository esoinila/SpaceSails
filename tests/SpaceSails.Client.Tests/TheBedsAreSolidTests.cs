...
public sealed class TheBedsAreSolidTests
{
    ...
    ///
    /// <para><b>Proven RED</b> by reverting the fix — i.e. by putting the beds back to the four rails they
    /// were laid as (<c>walls.Add</c> × 4 in <c>CarvePark</c>, instead of <c>SurfaceLayout.AddSolidMass</c>):</para>
    /// <code>
    /// (filled in from the run — see the PR body)
    /// </code>
    /// </summary>
    [Fact]
    ...
    ///
    /// <para><b>Proven RED</b> by reverting the fix — see the PR body for the run.</para>
    /// </summary>
    [Fact]
    ...
    ///
    /// <para><b>Proven RED</b> by deleting a bed's rails from <c>CarvePark</c> and laying only the label —
    /// see the PR body for the run.</para>
    /// </summary>
    [Fact]
