...
public sealed class TheSlowGateRosterTests
{
    ...
    private static readonly IReadOnlyDictionary<string, int> TheRoster =
        new Dictionary<string, int>(StringComparer.Ordinal)
        {
            ...
            // way #1108's row was: 12 tests, 67 s, and effectively all of it is the twelve real boots — each
            // one lands a captain on Miranda through the shipping descent before it can move the mothership.
            { nameof(TheShuttleCanCatchHerTests), 67 },
            ...
            // ── The death where nobody comes (#640), measured 2026-09-17 rather than in the 09-02
            //    baseline: six tests, six booted worlds, each one staging a real death and pressing the
            //    real "…wake up" — 23 s for the class ──
            { nameof(TheDeathWhereNobodyComesTests), 23 },
        };
